...
Les résultats sont écrits dans neuf CSV et un résumé JSON. Le script utilise
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        default="overwrite",
        help=(
            "overwrite remplace les CSV; merge fusionne et déduplique avec "
    ...
    # Étape 5 : écriture atomique, avec fusion historique optionnelle.
